 ...
 * Implementation of Section 3.1 Pairwise Collision Avoidance from
 * <a href="https://arxiv.org/abs/1902.05177">Multi-Objective Policy Generation
 * for Multi-Robot Systems Using Riemannian Motion Policies</a>
 */
public class CollisionAvoidance extends RMPLeaf {
	...
	/**
	 * A 1-d distance subtask space collision avoidance RMP Node between obstacle
	 * with radius r.
	 * 
	 ...
	 */
	public CollisionAvoidance(String name, RMPNode parent, SimpleMatrix center, double r, double epsilon, double alpha,
			double eta) {
		super(name, parent);
		this.r = r;
		this.alpha = alpha;
	 ...
	 * @param eta     A small positive scalar for avoidance metric
	 */
	public CollisionAvoidance(String name, RMPNode parent, Pose2d center, double r, double epsilon, double alpha,
			double eta) {
		this(name, parent, new SimpleMatrix(1, 2, false, new double[] { center.getX(), center.getY() }), r, epsilon,
				alpha, eta);
	}
	 ...
	 * @return // TODO: Describe what the derivative of a jacobian respresents in
	 *         this instance
	 */
	...
	/**
	 * Implementation of a barrier-type potential from Section 3.1 Pairwise
	 ...
	 * "https://github.com/gtrll/multi-robot-rmpflow/blob/master/rmp_leaf.py">Multi-Objective
	 * Policy Generation for Multi-Robot Systems Using Riemannian Motion
	 * Policies</a>
	 * <p>
	 * G(x, x_dot) = w(x) * u(x_dot)
	 * <p>
