 ...
 * <a href="https://arxiv.org/abs/1811.07049">RMPFlow Section 3.5</a>.
 */
public abstract class RMPLeaf extends RMPNode {
	...
	/**
	 * Solves for F
	 * , where F is the motion policy that describes the dynamical system as a
	 * second-order differential equation that uses position and velocity.
	 * 
