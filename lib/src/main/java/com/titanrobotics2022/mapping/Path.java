...
public interface Path {
     ...
     * 
     * <p>
     * This is equivalent to {@code getPos(0)};
     * 
     * @see #getPos(double)
     */
     ...
     * 
     * <p>
     * This is equivalent to {@code getPos(getLength())};
     * 
     * @see #getPos(double)
     * @see #getLength()
     */
     ...
     * 
     * <p>
     * This is equivanelt to {@link #getVelocity(double, double)} with a
     * speed of 1.
     * 
     * @param distance The distance along this path.
     * @return The velocity of motion along this path at the specified distance
     ...
     *         specified distance with the supplied velocity, assuming the particle
     *         is
     ...
     * 
     * <p>
     * This is equivanelt to {@link #getAngularVelocity(double, double)} with
     * a speed of 1.
     * 
     * @param distance The distance along this path.
     * @return The angular velocity of a particle moving along this path at the
     *         specified distance with the supplied velocity, assuming the particle
     *         is
     *         always oriented such that it is moving "forward". Equivalently, this
     *         can
     *         be viewed as the derivative of the orientation of such a particle
     *         with
     ...
     *                     this path. That is, the acceleration ignoring centripital
     *                     acceleration.
     ...
     * @param speed    The speed of motion along this path.
     * @return The acceleration of a particle moving along this path at the
     *         specified distance, with the provided speed. The returned value
     *         ignores
     ...
     * 
     * <p>
     * This method is equivalent to {@link #getAcceleration(double, double)}
     * with a speed of 1
     * 
     * @param distance The distance along this path to evaluate the
     *                 acceleration at.
     * @return The acceleration of a particle moving along this path at the
     *         specified distance, ignoreing acceleration in the direction of the
     *         path.
    ...
    public double getProgress(Point pos);
